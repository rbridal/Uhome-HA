...
# Configurable in options (1–5). Default 1 matches classic last_update_success
# behaviour; raise it to tolerate transient API blips.
CONF_MAX_UPDATE_FAILURES = "max_update_failures"
DEFAULT_MAX_UPDATE_FAILURES = 1
